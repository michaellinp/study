...
'''
import os
os.chdir(r'C:\Users\HTSB\Documents\quant books\Python Quant Book\part 3\019')
import numpy as np
import math
...
class MeanVariance:
    ...
    def frontierCurve(self):
        ...
        plt.scatter(self.returns.var(), self.returns.mean())
        plt.legend(loc='lower center',bbox_to_anchor=(0.5,-0.3), fancybox=True, shadow=True)
        plt.title('Mean Var Portfolio Optimization')
